...
?>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="branding">
                <img src="<?php echo theme_path('images/logo.png')?>" width="283" height="56" alt="Just Recruit"/>
        ...
        <div id="footer">
             &copy; <a href="http://www.justrecruit.com.sg" target="_blank">Just Recruit</a>. <?php echo $currentYear?> All rights reserved.
        </div> <!-- footer -->        
