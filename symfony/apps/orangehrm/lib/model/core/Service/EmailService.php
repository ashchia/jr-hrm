...
class EmailService extends BaseService {
    ...
    public function sendTestEmail($toEmail) {
        ...
        if ($mailType == 'smtp') {
            ...
            $body = "This email confirms that SMTP details set in Just Recruit are ";
            ...
            $body = "This email confirms that Sendmail details set in Just Recruit ";
            ...
            if (!empty($template)) {                
                ...
                foreach ($allRecipients as $recipient) {
                    ...
                    if (!empty($to)) {
                        ...
                        try {
                            $message->setTo($to);
                            $message->setFrom(array($this->emailConfig->getSentAs() => 'Just Recruit'));
