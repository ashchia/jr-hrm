...
<div class="modal hide" id="unitDialog">
    <div class="modal-header">
        ...
        <h3 id="title"><?php echo "Just Recruit - ".__("Edit Unit"); ?></h3>
    </div>
...
<script type="text/javascript">
    ...
    var lang_addUnit = "<?php echo "Just Recruit - ".__("Add Unit"); ?>";
    var lang_editUnit = "<?php echo "Just Recruit - ".__("Edit Unit"); ?>";
